 ...
 */
final class Version20230517191042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE simple (id INT AUTO_INCREMENT NOT NULL, choix_id INT NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_C17B3D02D9144651 (choix_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE simple ADD CONSTRAINT FK_C17B3D02D9144651 FOREIGN KEY (choix_id) REFERENCES choix (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE simple DROP FOREIGN KEY FK_C17B3D02D9144651');
